...
function Client(settings, callback) {
  ...
  if (!settings.blog && !settings.blogId) {
...
Object.defineProperties(Client.prototype, {
  ...
  validateLogin: {
    value: function validateLogin(user, password, callback) {

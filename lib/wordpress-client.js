...
Object.defineProperties(Client.prototype, {
  ...
  getPost: {
     ...
     * @returns {*}
     */
    value: function getPost(post_id, callback) {
      this.debug('getPost', post_id);

      this.methodCall('wp.getPost', [ this.get('blog'), this.get('username'), this.get('password'), post_id ], callback);

...
var solver = {
   ...
   */
  "date": function(data) {
    var ret = builder.create('dateTime.iso8601', {}, {}, {headless: true});
    ret.txt(data.toISOString());
    return ret.end();
  },
  /**
   * @param {{}} data
  ...
  "number": function(data) {
    ...
    var tag = data % 1 === 0 ? 'int' : 'double';
    return builder.create(tag, {}, {}, {headless: true}).txt(data).end();
  },
  /**
   * @param {boolean} data
   * @returns {string}
